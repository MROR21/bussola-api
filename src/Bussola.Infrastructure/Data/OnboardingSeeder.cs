...
public static class OnboardingSeeder
{
    ...
    public static async Task SeedAsync(AppDbContext db)
    {
        ...
        db.OnboardingSteps.AddRange(
            ...
            new OnboardingStep { Order = 7, FaseId = IdDaFase("Ambientação"), Title = "Ferramentas & acessos", Description = "Instale VS Code e Visual Studio; confirme acesso ao e-mail, Teams, Agilean Flow, Atlassian, Azure DevOps e Bússola.", IsCompanySpecific = true, Conteudo = Conteudos[6] },
            new OnboardingStep { Order = 6, FaseId = IdDaFase("Ambientação"), Title = "RH, DP e benefícios", Description = "Pagamento, plano de saúde, treinamentos e quem chamar no RH.", IsCompanySpecific = true, Conteudo = Conteudos[7] },
